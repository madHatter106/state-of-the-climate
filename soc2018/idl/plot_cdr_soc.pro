...
; -----------------------------------------------------------------------------------------------
; -----------------------------------------------------------------------------------------------
pro plot_cdr_soc, prod, region, tids, range=range, tdirs=tdirs, title=title, odir=odir, anomaly=anomaly, years=years, clim_years=clim_years,width=width, mei=mei, bias=bias
...
if (keyword_set(anomaly)) then begin
    ...
    ytitle = 'Chla (mg m!e-3!n)!C'    ; note the !C is a carriage return that moves the label over
endelse
